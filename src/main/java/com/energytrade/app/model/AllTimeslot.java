...
public class AllTimeslot implements Serializable {
	...
	@OneToMany(mappedBy="allTimeSlot")
	private List<TimeslotRates> timeslotrates;

	public List<TimeslotRates> getTimeslotrates() {
		return timeslotrates;
	}

	public void setTimeslotrates(List<TimeslotRates> timeslotrates) {
